    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="social.html">Social Media</a></li>
...
<img src="img/tweet.png" id="bird" style="max-width:200px">
     <h1>Thanks for submitting your tweet!</h1>
     <p>You tweeted:</p>
     <p id="getTweet"> <?php echo $_POST["tweet"]; ?></p>
</div>
<div class="col-md-6">
  <a class="twitter-timeline"
  href="https://twitter.com/SHomes101"
  data-width="300"
  data-height="300">

Tweets by @SmartHomes101
</a>
</div>
...
<script>
  ...
  <!--<script src="js/main.js"></script>-->
   ...
   <script src="js/newTweet_compressed.js" defer></script>
